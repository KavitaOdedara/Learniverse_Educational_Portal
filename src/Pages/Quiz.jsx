...
//     return (
//         <div className="p-10">
//             <h2 className="text-center text-gray-700 font-semibold dark:text-white mt-5">
...
//                             <div className="text-center text-lg sm:text:3xl capitalize py-6 font-medium tracking-wider dark:text-white">
...
//             ) : (
//                 <div className="p-5">
//                     <h3 className="text-lg font-bold text-gray-800 dark:text-white">{selectedCourse} Quiz</h3>
...
//                             className="flex items-center justify-center w-12 h-12 text-lg font-medium rounded-full bg-blue-600 text-white cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed hover:bg-blue-500 active:bg-blue-700 transition-all"
//                         >
...
//                         <button
//                             onClick={submitQuiz}
//                             className="flex items-center justify-center w-12 h-12 text-lg font-medium rounded-full bg-blue-600 text-white cursor-pointer hover:bg-blue-500 active:bg-blue-700 transition-all"
//                         >
