...
const AppDev = () => {
  ...
  const appDevelopment = [
    { name: "Android Development with Kotlin", image: KotlinImg },
    { name: "iOS Development with Swift", image: SwiftImg },
    { name: "React Native", image: ReactNativeImg },
    { name: "Flutter with Dart", image: FlutterImg }
  ];
      ...
      <section>
         <div>
           <div className="flex justify-center mt-5">
             <h1 className="title-font sm:text-4xl text-2xl mb-4 font-medium text-gray-900"><span className="text-cyan-600">App</span> Development</h1>
           </div>
           <div className="text-center capitalize text-gray-700 font-semibold dark:text-white mt-5">
             <h5>Learn the basics of building your first app with our easy to follow App Development courses.</h5>
           </div>
         </div>
             ...
             {appDevelopment.map(course => (
              <div key={course.name} className="rounded overflow-hidden shadow-lg">
                ...
                <div className="px-6 py-4 font-semibold text-lg inline-block hover:text-cyan-600 transition duration-500 ease-in-out">
                  ...
                  Learn {course.name} and build the foundation for modern Mobile applications.
                  </p>
                </div>
